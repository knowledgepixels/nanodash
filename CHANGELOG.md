...
* "add..." actions on the About-page preset/view-display listings ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([ada006d](https://github.com/knowledgepixels/nanodash/commit/ada006d7fd199155ea31edd3a771a50309d6a6ef))
* "displayed here" flag on view-displays tables for all entity types ([bd09676](https://github.com/knowledgepixels/nanodash/commit/bd096761ae3ebdc8f27da2b81fda3297de8266b4))
* "Pending Admins/Maintainers/Members" space view for unapproved role claims ([a3671b7](https://github.com/knowledgepixels/nanodash/commit/a3671b73cc61d7e9feaf6778899dd30d7001b918))
* `_noheader` column suffix to hide TabularView header labels ([d2a1e63](https://github.com/knowledgepixels/nanodash/commit/d2a1e63ccb56de7c6bf69351fac31f2b10b69b2c))
* account controls on own About tab; outline dropdown chevron ([19720f2](https://github.com/knowledgepixels/nanodash/commit/19720f2b26cc8e20b757361115b923b3634d77eb))
* add "^" explore link to /explore "Described in" entries + rename view ([5dbb1e0](https://github.com/knowledgepixels/nanodash/commit/5dbb1e08aadebd0e42499989710dabb17338b032))
* add "👥 Members" view to the space About tab ([56e8ef3](https://github.com/knowledgepixels/nanodash/commit/56e8ef3993d9d1b1a908e7f4a79f73fa1ff2beb3))
* add "Nothing found." marker to NanopubSetView ([1ff8314](https://github.com/knowledgepixels/nanodash/commit/1ff8314fb2c9f6f50fe57ce356166da77bbd1c69))
* add About tab to resource part pages ([8f7a856](https://github.com/knowledgepixels/nanodash/commit/8f7a856cf595ecabb443ba6cf69183149b967b98))
* add Assigned roles view to space About page; cleaner role/view-display queries ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([0947361](https://github.com/knowledgepixels/nanodash/commit/0947361d5bc6855ef7fecd952f4013768cf3ec9a))
* add Content/Explore tabs to the standalone Explore page ([aa6b354](https://github.com/knowledgepixels/nanodash/commit/aa6b354cbc01a7c64a9a39d03dffbed38d76422c))
* add gen:EveryoneRole visibility sentinel; record view template ([d91479b](https://github.com/knowledgepixels/nanodash/commit/d91479bbd126ffc60a9e243ca7eed818bf0ef1dd))
* add Info section to the part About tab ([bf63fd7](https://github.com/knowledgepixels/nanodash/commit/bf63fd79cc400b84be12b2c6780645fcc35aa7bd))
* add nanopub "^" explore link to /explore view-display entries ([8b4b66b](https://github.com/knowledgepixels/nanodash/commit/8b4b66bb9a92a5abd42904ee111ab4655e07d4ef))
* add Observers view to space About tab; share stripe with Members ([0c54e73](https://github.com/knowledgepixels/nanodash/commit/0c54e7342ff89bed3b8c6994b68378993c809e3a))
* add standalone About pages for spaces, resources, and users ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([f3991bd](https://github.com/knowledgepixels/nanodash/commit/f3991bdb77ae4bdbd18a189049e29d4b2d588780))
* add Sub-units section to space About page as list views ([e2ffc6d](https://github.com/knowledgepixels/nanodash/commit/e2ffc6d618c17ed333469654b02d204f22e2fe3a))
* annotate introductions keys with approval status + style in-cell emoji ([e5ae715](https://github.com/knowledgepixels/nanodash/commit/e5ae715160c19ec155266cf62eb7c95a78b8a484))
* apply view filters live as the user types ([f3bddb1](https://github.com/knowledgepixels/nanodash/commit/f3bddb1eaf0a7b57ad3842d6d426bf9564120d17))
* breadcrumb label splitting, dropdown styling, np-column tweaks ([77bb465](https://github.com/knowledgepixels/nanodash/commit/77bb465355d9ce2bfa0bafa7570430a64a1474fe))
* broaden post-publish refresh and add context-aware tab landing ([8c172e2](https://github.com/knowledgepixels/nanodash/commit/8c172e25e96b44f50d6e0950571038c18b181f6f))
* bump About-page view heads (gating + template fixes) and Sub-units icon ([e529596](https://github.com/knowledgepixels/nanodash/commit/e52959629ecc4bb6301e84137ae5f9f32e1bb8ef))
* claimants disambiguation as a collapsible inline notice ([8509829](https://github.com/knowledgepixels/nanodash/commit/8509829498d3251d7e39d2940b39e4d970fcb533))
* claimants overview + ref-pinned space pages (disambiguation) ([7c157c9](https://github.com/knowledgepixels/nanodash/commit/7c157c96b71273d3c815133f4f08167147bd7970))
* consistent italic "(nothing found)" empty state across query views ([ee73c5b](https://github.com/knowledgepixels/nanodash/commit/ee73c5b10f9c5a378c2607c4fa2a0beaed7a5aef))
* consolidate resource pages into Content/About/Explore/Raw tabs ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([89808eb](https://github.com/knowledgepixels/nanodash/commit/89808eb71aedce675f103987b2222a319de408e8))
* consolidate the profile experience onto the user About page ([117c8e4](https://github.com/knowledgepixels/nanodash/commit/117c8e4a285ac1ba14d09016666b90d9c0ce509e))
* deactivate grid view mode for nanopub-set view (list only) ([72c8e6c](https://github.com/knowledgepixels/nanodash/commit/72c8e6c82c289316bc7c507aab0dfaf16dd93e06))
* disambiguation notice for spaces with conflicting refs ([a6413f5](https://github.com/knowledgepixels/nanodash/commit/a6413f55791c63e080f26879c4c6e18e3b88dd00))
* entry-action visibility + multiple/non-param mappings (magic-params phase 2) ([cbe1d24](https://github.com/knowledgepixels/nanodash/commit/cbe1d248cc61535ab8db19b27a0778109d600d50))
* expose Nanodash-Version response header ([5d7f083](https://github.com/knowledgepixels/nanodash/commit/5d7f083e9b1efff2438b4ff7b3741e780eac7417))
* gate render-path view displays by admin/maintainer/affected user ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([bcc02f2](https://github.com/knowledgepixels/nanodash/commit/bcc02f2a3a5dd9e79c0a1de1812ae7c84fb312d4))
* gate view action buttons by role via gen:isVisibleTo on action nodes ([ecda3df](https://github.com/knowledgepixels/nanodash/commit/ecda3df99518bc8f55c8f3e8d1a2e1f52dde23b8))
* group About-tab listings into titled sections; preset view to v5 (6/12 wide) ([763d223](https://github.com/knowledgepixels/nanodash/commit/763d2239bb5114f9bc8bc8d2678f1f7effd0b4e9))
* group rec/intro + presets/view-displays into shared stripes; rec icon 👋→👉 ([c0eeedf](https://github.com/knowledgepixels/nanodash/commit/c0eeedf7b7818f587bd8e4c4a53ba34722ced980))
* hard-code recommended actions into the "This is you" box ([f373fd3](https://github.com/knowledgepixels/nanodash/commit/f373fd3d6a0209dc7beed368aeb12ea931baafc6))
* harden latest-view resolution in view-display queries ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([b439e7e](https://github.com/knowledgepixels/nanodash/commit/b439e7e319addd0dba7890aa3860860adf66d10b))
* hide result filter textfield when all rows fit on the first page ([737989b](https://github.com/knowledgepixels/nanodash/commit/737989b3ad761601f22e926c9ec281ba301aa811))
* introductions/recommendations as views + ListView render fixes ([eab57b3](https://github.com/knowledgepixels/nanodash/commit/eab57b38eef1af696e7949fc793a4a1103ba8e8d))
* latest-version view listing and collapsed view chains on About pages ([c168e77](https://github.com/knowledgepixels/nanodash/commit/c168e77e9039f6b95c98167665de26a91eeb6e61))
* merge account + signing-key into a highlighted "This is you" header box ([4b68076](https://github.com/knowledgepixels/nanodash/commit/4b68076af7f9e3513355b537c471aa108dff3740))
* move view + entry actions into dropdown menus ([8830704](https://github.com/knowledgepixels/nanodash/commit/8830704a1b9645346cacbcb459b5a370c5530c6f))
* part About add-view-display action targets the owning resource ([5c03729](https://github.com/knowledgepixels/nanodash/commit/5c037298e8c47f495c05125b29363543886ab945))
* part-page presets/view-displays target the owning maintained resource ([01a822a](https://github.com/knowledgepixels/nanodash/commit/01a822a8be35e413426f2a6ea58c82bf107c2fa9))
* per-row deactivate action in View-displays view; fix meta-view menu ([57c9da5](https://github.com/knowledgepixels/nanodash/commit/57c9da5dcd12514cd71f2d3f196619c472ff35a2))
* per-type "add preset" templates (type-filtered preset choice) ([bc2ff6e](https://github.com/knowledgepixels/nanodash/commit/bc2ff6ee1b3721a0b14a0157a1250bf2bd59b20d))
* per-type "add view display" templates via listing views ([23d88ca](https://github.com/knowledgepixels/nanodash/commit/23d88ca602f1567451fe082448d6a906ae0fd2a8))
* point preset-assignments view to v6 with per-row deactivate action ([d1637d8](https://github.com/knowledgepixels/nanodash/commit/d1637d81789c6de2a7c62171f0676b276f37e684))
* point preset-assignments view to v9 with active-only listing ([2cdd7e8](https://github.com/knowledgepixels/nanodash/commit/2cdd7e8c2906883823eca8ab4d37261c419d689d))
* point space listing at ref-aware get-spaces (v3) ([48b9e64](https://github.com/knowledgepixels/nanodash/commit/48b9e6417bb2d6598ba4894efcd0edbf0c87e4e3))
* point space-roles view to v11 with renamed built-in admin role ([c1c6c5b](https://github.com/knowledgepixels/nanodash/commit/c1c6c5b3f1825e4ca1228b8464b26fdfb5e899fa))
* point space-roles view to v13 with tier column and 6/12 width ([48b6e94](https://github.com/knowledgepixels/nanodash/commit/48b6e94edb5e3e54ca72c92aed08ad539718bb01))
* point space-roles view to v14 with width and add-role/add-user actions ([d1fc125](https://github.com/knowledgepixels/nanodash/commit/d1fc1259706dd369cc6bb521304f6867cdc49be6))
* point space-roles view to v17 (preset marking from materialized attachment) ([754ead7](https://github.com/knowledgepixels/nanodash/commit/754ead714e177293c0b72882003033c0c4bb045f))
* pre-fill sub-resource namespace from a Space context in view result-actions ([b616e17](https://github.com/knowledgepixels/nanodash/commit/b616e17faf7499ea7a27659baa146c1cd14f7def))
* prominent "Create Introduction" button in the account box ([59b4755](https://github.com/knowledgepixels/nanodash/commit/59b47558d6cb8b5b22b72518ddf7df98ea3b323b))
* promote view actions to call-to-action buttons in empty tables ([424aefa](https://github.com/knowledgepixels/nanodash/commit/424aefa73eda784463d1e34a4fb304f12732ea0a))
* re-query a page's views on a genuine browser reload ([1ce51e0](https://github.com/knowledgepixels/nanodash/commit/1ce51e049e531da13a21a056d26bb0f3fb1ae999))
* ref-aware get-spaces (v3) + ref-keyed space repository (stage 1) ([04a9d58](https://github.com/knowledgepixels/nanodash/commit/04a9d58b9e1747c8826859f825dfe77627b51cb4))
* ref-scope observer/non-approved queries for space aliases ([6786f73](https://github.com/knowledgepixels/nanodash/commit/6786f73e7e35dbcdc5b16b984fdbff413e62c989))
* ref-scope the Assigned presets table ([#122](https://github.com/knowledgepixels/nanodash/issues/122) / [#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([ec19284](https://github.com/knowledgepixels/nanodash/commit/ec1928456c9fadd47ee32a1fd88e74c2c9807e2e))
* ref-scope the four About-tab listing views (members, roles, sub-spaces, maintained) ([c629e5b](https://github.com/knowledgepixels/nanodash/commit/c629e5b2b7491ca21b1ada980e76251b40728aec))
* ref-scope view action visibility to the pinned ref ([693bfb0](https://github.com/knowledgepixels/nanodash/commit/693bfb047d058374e297db81b4bdfe7c80c880ef))
* ref-scope view displays (About listing + Content rendering) ([4eef2b4](https://github.com/knowledgepixels/nanodash/commit/4eef2b4216081a5931b6471ca6f690db14bfbf06))
* ref-scoped admin pubkey hashes (stage 2 slice) ([aa24932](https://github.com/knowledgepixels/nanodash/commit/aa24932532f47bf09fa3f69b0951f6381a7d3c6c))
* ref-scoped roles + flagged ref-scoped members (stage 2 slices) ([fb12916](https://github.com/knowledgepixels/nanodash/commit/fb12916f0a5a144ff3855e0efc25bfc2a0e90465))
* ref-scoped space admins query (stage 2 slice) ([a0d96f1](https://github.com/knowledgepixels/nanodash/commit/a0d96f1c7893da57efe499aa9f8eccb614517a86))
* refine recommended-action wording in the account box ([b706207](https://github.com/knowledgepixels/nanodash/commit/b70620709ac3ede33b5747b07eb9bd53a87f80fd))
* remove "🧩 Has parts" view from /explore ([86ee6dd](https://github.com/knowledgepixels/nanodash/commit/86ee6ddaf2e9015c8157fbad869d76ace2675a74))
* remove the dropdown menu next to the space identifier ([39eb001](https://github.com/knowledgepixels/nanodash/commit/39eb001d9954b54e6d8f9a96fb8e2a19fd0e20f6))
* render /explore "Described in" as a NanopubSetView ([2bc87f2](https://github.com/knowledgepixels/nanodash/commit/2bc87f283cd8f0534f15b437fead50f2485873eb))
* render /explore "Described in" as a view display + list empty-state note ([3337ee0](https://github.com/knowledgepixels/nanodash/commit/3337ee0f80bc5cfd8758f88f18207f83ff7e1168))
* render /queries panel as a proper ResourceView with dropdown menu ([6df2eca](https://github.com/knowledgepixels/nanodash/commit/6df2ecae80d5f0e23bdc5d18a58c5796e4accf8e))
* render /references as a proper view display ([babb607](https://github.com/knowledgepixels/nanodash/commit/babb60753066b69c85f9e5d2bfb9f0b329da5a55))
* render /spaces as a single sortable All Spaces table ([59b029a](https://github.com/knowledgepixels/nanodash/commit/59b029ab3c6ff036af6dba247bc97a3a336d15b0))
* render /userlist Human/Software/Non-Approved lists as item-list views ([b07e5c9](https://github.com/knowledgepixels/nanodash/commit/b07e5c9a69b73003f73b8965d0cadfcd2ccd1545))
* render About/Explore tabs instantly, loading content lazily when uncached ([9ef0f0f](https://github.com/knowledgepixels/nanodash/commit/9ef0f0fcce302e0143388d8f3e94c513f84071ef))
* render preset-supplied views and list them on About pages ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([0d9f8c7](https://github.com/knowledgepixels/nanodash/commit/0d9f8c752793bd686905610d5a0b7b60b48fdb52))
* render remaining /explore lists as view displays ([d0d5921](https://github.com/knowledgepixels/nanodash/commit/d0d59212e8fbe64ea15098742939f12592a93b7d))
* render space "Assigned roles" as a table with user counts ([7467914](https://github.com/knowledgepixels/nanodash/commit/7467914f4f5654ef60eeff0bd147fe2a2bb7d3a9))
* render space Assigned-roles as a list view with role actions ([8b0e6bf](https://github.com/knowledgepixels/nanodash/commit/8b0e6bfcc976a3fb5a490e7a43af8b7ffc9e94c2))
* render view result actions on resource-less listings (e.g. /spaces) ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([4ffb663](https://github.com/knowledgepixels/nanodash/commit/4ffb663cfa54ebbd0c89831d9a3ad82f20688c08))
* replace copy-link alert with a transient top toast ([c5ed56e](https://github.com/knowledgepixels/nanodash/commit/c5ed56e744e6ac58cb7e9e9bcc6d6cb9ef175f6a))
* replace copy-link icon with a borderless "copy" dropdown ([2134a70](https://github.com/knowledgepixels/nanodash/commit/2134a70956b7b3f19862bcea49fd0a2b1288e002))
* require nanopub-query 1.16+ ref-scoped spaces backbone ([02d5caa](https://github.com/knowledgepixels/nanodash/commit/02d5caa940ad0e5ab6fd794271b55f002cbc6ba0))
* resolve latest view versions in get-view-displays query ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([9d81e2a](https://github.com/knowledgepixels/nanodash/commit/9d81e2af6b40cd27f088ac65d3978c2e7360f9d5))
* restyle dropdown menus and open them leftward ([f75ca2b](https://github.com/knowledgepixels/nanodash/commit/f75ca2b2717228048b18e867d77409370cd0002d))
* role-tier model + gen:isVisibleTo view-display visibility filter ([f10bc9f](https://github.com/knowledgepixels/nanodash/commit/f10bc9fe94a3ac488c6e247231ea9032ba19c62c))
* serve stale view resolutions while re-resolving in the background ([e44adc4](https://github.com/knowledgepixels/nanodash/commit/e44adc43210040453c1087ec37198ca7b4f38a79))
* session-bound "magic" query parameters (binding infra) ([34eca15](https://github.com/knowledgepixels/nanodash/commit/34eca152d6869c9bbbc4e56d9b2ef74df0c0192e))
* show all templates on Publish page as a single sortable table ([6aa2521](https://github.com/knowledgepixels/nanodash/commit/6aa25212e584d016fd56503b9eab67f192b1bbcd))
* show dates as friendly relative times ("10 minutes ago") ([e881146](https://github.com/knowledgepixels/nanodash/commit/e88114680a3f340bc042013b4d2fc2c104c4009a))
* show only References on the resource Explore tab ([230f613](https://github.com/knowledgepixels/nanodash/commit/230f61323a628419b194ba02b65e190351e62f30))
* show signing key in Account section of own About tab ([a35fc31](https://github.com/knowledgepixels/nanodash/commit/a35fc311c5370840d5422480d706615bcde74b8b))
* show un-introduced observers with a warning flag (stage 2) ([1c907fb](https://github.com/knowledgepixels/nanodash/commit/1c907fb3deb8604b403f4d110cebed566f3b6041))
* slim down Space page header/content; tab + copy-icon styling ([11bb518](https://github.com/knowledgepixels/nanodash/commit/11bb518a4cda2097b15579e749fbfb22170d1703))
* source admin pubkey hashes from spaces-repo state graph ([060d2a4](https://github.com/knowledgepixels/nanodash/commit/060d2a4f04c750af9a8333a80dde2770d811c464))
* source GET_SPACES from spaces repo ([77454a6](https://github.com/knowledgepixels/nanodash/commit/77454a62a6ff7e74efd21b8bcc2ed265484409a4))
* source maintained resources from spaces repo ([28ac65a](https://github.com/knowledgepixels/nanodash/commit/28ac65a16266c01cac29215ef81c6bf387679d50))
* source space admins/members/roles/pubkey-hashes from published grlc queries ([0354b3e](https://github.com/knowledgepixels/nanodash/commit/0354b3eb956ca0418950f55f00505adbdd3145c8))
* source space admins/members/roles/sub-spaces from nanopub-query spaces repo ([637f171](https://github.com/knowledgepixels/nanodash/commit/637f171b2dac3f8169fab6769481eb3a4b10c7f0))
* source spaces, sub-space links and maintained resources from published grlc queries ([f3d799e](https://github.com/knowledgepixels/nanodash/commit/f3d799e1075a0a35cabe04da317ac18d99d999d3))
* source user/admin pubkey-hash expansion from spaces repo ([ddda26d](https://github.com/knowledgepixels/nanodash/commit/ddda26da3a83a4718db8eee27d4882bf75537041))
* surface ref-aware space/maintained Info views on Content + About tabs ([c9c18c5](https://github.com/knowledgepixels/nanodash/commit/c9c18c517e6964cba1d1af2c238286635177fea4))
* treat a leading symbol/emoji in action labels as the entry icon ([240df3d](https://github.com/knowledgepixels/nanodash/commit/240df3d33ca4dc7e5df290851ab56bffa614ec03))
* underline About-section h3 headers and shrink h4-h6 to 11pt ([f3a2218](https://github.com/knowledgepixels/nanodash/commit/f3a2218b46b64e87200c5358def191e5128798d9)), closes [#bdbdbd](https://github.com/knowledgepixels/nanodash/issues/bdbdbd)
* unify post-publish message into title bar + always-on intro nudge ([0b01014](https://github.com/knowledgepixels/nanodash/commit/0b01014e44e6b34798be9aef997f78ac6a5be80f))
* user About page views (introductions, profile) + alpha table stripes ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([825da0b](https://github.com/knowledgepixels/nanodash/commit/825da0baa8d389b7383b4455e09fc4d46cd4550c))
* view-styled intro companion on own About tab; drop retract view action ([32d9bfe](https://github.com/knowledgepixels/nanodash/commit/32d9bfed2715d11e6b4d9a41014f602044a086b6))

### Dependency updates

* **core-deps:** update org.json:json dependency to v20260522 ([77e002f](https://github.com/knowledgepixels/nanodash/commit/77e002f9bbec0d427ef4323943cdaf4416de8026))
* **deps:** update dependency maven to v3.9.16 ([913f4b5](https://github.com/knowledgepixels/nanodash/commit/913f4b584e19140d686857092c5a5b22c5d6a8d2))
* **deps:** update release dependencies to latest version ([5556185](https://github.com/knowledgepixels/nanodash/commit/5556185a4ab9df322944c676ddf0575e2355b983))

### Bug Fixes

* align NanopubSetView first-card gap with list views (8px) ([16c1e2c](https://github.com/knowledgepixels/nanodash/commit/16c1e2cca4a2c46aa6f6496483acc2c01b405549))
* apply same GRAPH/OPTIONAL fix to role-loading query ([28eb998](https://github.com/knowledgepixels/nanodash/commit/28eb9986dfb87f213abee369829ae24537c3946a))
* correct appliesToInstancesOf on user/maintained view-displays views ([2e13ccb](https://github.com/knowledgepixels/nanodash/commit/2e13ccb721e0d1d394ef74962440dc945cdaeaec))
* default spaces-repo SPARQL to query.nanodash.net ([fe99e16](https://github.com/knowledgepixels/nanodash/commit/fe99e169217a2a5238e99afe6756ad46c4fecf1f))
* define nanopub graph background as alpha so it stays visible on stripe ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([bbcb400](https://github.com/knowledgepixels/nanodash/commit/bbcb400b88b5d9244caa11bf199b26d9920b072d)), closes [#F3F6F9](https://github.com/knowledgepixels/nanodash/issues/F3F6F9) [#F3F6F9](https://github.com/knowledgepixels/nanodash/issues/F3F6F9)
* ensure resources are loaded in findResourcesBySpace ([64812fa](https://github.com/knowledgepixels/nanodash/commit/64812fa52eded8099a09f80edf09b13abd2ecc37))
* fill magic params and generic service URLs in "Open in Yasgui" link ([#482](https://github.com/knowledgepixels/nanodash/issues/482)) ([29c5650](https://github.com/knowledgepixels/nanodash/commit/29c56505463a54a79de2b9347ea53e81f00e6723))
* gate member RIs by role-predicate match, not by signer being admin ([6fa5170](https://github.com/knowledgepixels/nanodash/commit/6fa517030dd40601078144b86650b5a74f9bbd9b))
* gate observer/non-approved invalidations on same pubkey ([#487](https://github.com/knowledgepixels/nanodash/issues/487)) ([2b4ad33](https://github.com/knowledgepixels/nanodash/commit/2b4ad33392c1a59f15f6877c6971f554706ac96e)), closes [#112](https://github.com/knowledgepixels/nanodash/issues/112)
* gate preset & view-display actions on About panels ([a980214](https://github.com/knowledgepixels/nanodash/commit/a9802147daf29cf72ee2d5f05ede4e01c3a0becc))
* gate remaining core-query invalidations on same pubkey ([#487](https://github.com/knowledgepixels/nanodash/issues/487)) ([6d8dfcd](https://github.com/knowledgepixels/nanodash/commit/6d8dfcdaf0722f2044f939febafc7e578ccc277d)), closes [#112](https://github.com/knowledgepixels/nanodash/issues/112)
* honor postpub-redirect-url on preview→publish flow ([60f4a79](https://github.com/knowledgepixels/nanodash/commit/60f4a79ccdea0cb0f015165e9c22071ad58b4f12))
* keep assigned presets and view displays in one shared stripe ([0ca24ce](https://github.com/knowledgepixels/nanodash/commit/0ca24ce4e10b7ef2077074460ea2e3e2f4a44413))
* keep copy dropdown collapsed next to inline alternative IDs ([a171543](https://github.com/knowledgepixels/nanodash/commit/a171543f168316ad3bd286c7dc9a87b0871bc9a1))
* label admin role assignments by schema:name in Members view ([97b52ae](https://github.com/knowledgepixels/nanodash/commit/97b52aeeb002aeccd59bf0758743c19d73531794))
* match Create Introduction button height to logout ([efd41d0](https://github.com/knowledgepixels/nanodash/commit/efd41d0be212b03387ddef3e75e47873915cf433))
* move namespace OPTIONAL outside GRAPH wrapper ([0ab2006](https://github.com/knowledgepixels/nanodash/commit/0ab200631cab6bf999d72878282e904b9f59bed8))
* observers query returns only the latest nanopub per role ([9871e32](https://github.com/knowledgepixels/nanodash/commit/9871e32b6b2ee5a87494f867ecf85cb03aa207e1))
* only forward to part page when resource actually qualifies as a part ([18608d4](https://github.com/knowledgepixels/nanodash/commit/18608d4d8d174e09dd6c058e7b5d95b59ec6c8ee))
* pack an action's query mappings into one whitespace-separated literal ([f5d4211](https://github.com/knowledgepixels/nanodash/commit/f5d42119f38da95862c7650dba2ebe4feed30fc8))
* pin observer role label to the space's assigned role ([7f2923a](https://github.com/knowledgepixels/nanodash/commit/7f2923a0ee6266080167ae253bb096fabfe041e4))
* place preset-supplied views by their own targeting ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([471bf0a](https://github.com/knowledgepixels/nanodash/commit/471bf0af92caa85ec2e40c3b46952673391d951a))
* point Observers view at space-assigned-roles-only query ([ac08067](https://github.com/knowledgepixels/nanodash/commit/ac0806740106f6addcca6aa4869b8cb71ed61555))
* reduce gap above first card in NanopubSetView (list mode) ([5819c51](https://github.com/knowledgepixels/nanodash/commit/5819c514c0ca2e30371a1bfee743b0312b9fae60))
* remove view-selector bottom padding in NanopubSetView header ([26ec817](https://github.com/knowledgepixels/nanodash/commit/26ec817a0d5b276fcd99ab3588e190d4006bdd0d))
* render in-cell result-table emoji monochrome without blue tint ([c2906e8](https://github.com/knowledgepixels/nanodash/commit/c2906e89d9ba018569f42087c48acf32c29d0c09))
* repair malformed get-view-displays nanopub (double-slash op IRI) ([6f194d1](https://github.com/knowledgepixels/nanodash/commit/6f194d10cfb570a13d1420f8f8aeaf29457cb74d))
* route entitlement to bare accessors when no ref is pinned ([eb7ba5e](https://github.com/knowledgepixels/nanodash/commit/eb7ba5ef86c1b097ee90888b87672dfa75a4ff9b))
* sanitize PlainParagraph content; tidy title-less paragraph layout ([af42755](https://github.com/knowledgepixels/nanodash/commit/af42755adeb2dc6252bcb4cc7453d998dff1812a))
* seed appended repetition-group fields when deriving (empty key-declaration bug) ([e576417](https://github.com/knowledgepixels/nanodash/commit/e5764170e89cdf3eb7c03c936e4f0ed4c0fb84a2)), closes [#271](https://github.com/knowledgepixels/nanodash/issues/271)
* show one concise breadcrumb crumb per path level ([8d47b06](https://github.com/knowledgepixels/nanodash/commit/8d47b0613ecdfa3679d1496d7ea405b0b655bb4a))
* skip IRI creation for empty creator in TemplateItem ([#485](https://github.com/knowledgepixels/nanodash/issues/485)) ([315465a](https://github.com/knowledgepixels/nanodash/commit/315465aaac00637fe3490be2d93d41b8d2f24d89))
* sort spaces by label within each type panel on the spaces list ([63dadcc](https://github.com/knowledgepixels/nanodash/commit/63dadcc7ce87874094377dc497e450f705c6f046))
* source members from extraction graph with client-side admin gate ([ae71432](https://github.com/knowledgepixels/nanodash/commit/ae71432d3dfbeb64b9ed079f7347173d3e687f4c))
* strip spaces prefix for sub-space add-action pre-fill ([03c8f85](https://github.com/knowledgepixels/nanodash/commit/03c8f85ae94749d482e033b7312ec7b0a26d0bbe))
* surface root nanopub placeholder as "this nanopublication" in supersede ([65b0c84](https://github.com/knowledgepixels/nanodash/commit/65b0c8452db55d94854a3249affe7fdac5822f5b))
* tighten "Nothing found." spacing in NanopubSetView empty state ([119f224](https://github.com/knowledgepixels/nanodash/commit/119f224855085d31cdd549de2a974cf3be68827a))
* tighten margin around "Nothing found." note ([c7e041c](https://github.com/knowledgepixels/nanodash/commit/c7e041ce9b994cba1ce262faed018caed6e2ba44))
* treat "void" action-field sentinel as not-set in View parsing ([820f44e](https://github.com/knowledgepixels/nanodash/commit/820f44e25d710ff93011c9af3e0b9859ca109979))
* update view-displays-view nanopub reference ([#478](https://github.com/knowledgepixels/nanodash/issues/478)) ([c194b9b](https://github.com/knowledgepixels/nanodash/commit/c194b9bf9427c3d38aa2bbdc92d3d7e92b460255))

### Documentation

* add presets design document ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([1a9cec6](https://github.com/knowledgepixels/nanodash/commit/1a9cec67ca8799c64efaaece8b3a05423d54b27a))
* add role-specific-views design note ([2ab36e8](https://github.com/knowledgepixels/nanodash/commit/2ab36e873725d14feaca54d4b1d7d22559cd5fc5))
* add space-ref identity design doc (IRI + root-definition NPID) ([e99afc7](https://github.com/knowledgepixels/nanodash/commit/e99afc7924e8e923b3cc2c0854bde4f35d888bff))
* bring space-ref-identity doc up to date with shipped Stage 2 ([0a04c04](https://github.com/knowledgepixels/nanodash/commit/0a04c0427f3683fb7c6cb190e7fb6f39c0fd9a24))
* consolidate doc/ into docs/; add status headers and index ([c96c6c1](https://github.com/knowledgepixels/nanodash/commit/c96c6c1278f34349559638497cc0742143423893))
* design note for session-bound ("magic") query parameters ([e5a82d3](https://github.com/knowledgepixels/nanodash/commit/e5a82d3d3813abf75e2c822579c13a9a6d3e938a))
* drop vestigial server-side enforcement; mark role-specific-views done ([503a073](https://github.com/knowledgepixels/nanodash/commit/503a073555e61a9764bfafcee2eec5dc6db35f8e))
* mark magic-query-params complete; trim dropped/stale detail ([f6271fc](https://github.com/knowledgepixels/nanodash/commit/f6271fceb983e2196d23e9419dfd9a0a188b4d14))
* mark magic-query-params Implemented in the docs index ([d3c6f20](https://github.com/knowledgepixels/nanodash/commit/d3c6f20884361c9a44094bac9acab5b296afdfc7))
* mark presets Implemented; resolve the doc's open questions ([73a4d0f](https://github.com/knowledgepixels/nanodash/commit/73a4d0fe199799e5fe1acfac833ea349aa6146c8))
* note how to pin nanodash to a single query instance ([1aafa5d](https://github.com/knowledgepixels/nanodash/commit/1aafa5d842786534aea98676511771bbf57ede73))
* phase-3 design (introductions as views) + CURRENTUSER magic param ([acef7f7](https://github.com/knowledgepixels/nanodash/commit/acef7f7991d08593066bf1698e0cc8347ada2011))
* record the preset/view-display action-leak fix ([4809936](https://github.com/knowledgepixels/nanodash/commit/480993615d533ec394149eee80fc4a9b8bb724fe))
* record view-displays-view fork merge + current view heads ([c00a307](https://github.com/knowledgepixels/nanodash/commit/c00a307f97425bf0a70f1d7f07f02fd8e9332c7b))

### Performance improvements

* run-once view resolution in get-view-displays query ([#302](https://github.com/knowledgepixels/nanodash/issues/302)) ([b2b6b6d](https://github.com/knowledgepixels/nanodash/commit/b2b6b6da1a21f7abe9f8657bab31036fbeb740bf))

### Tests

* **deps:** update junit-framework monorepo to v6.1.0 ([54a797f](https://github.com/knowledgepixels/nanodash/commit/54a797f42a061f182975bd5838fb39f50ff8c501))
* make MagicQueryParamsTest robust to leaked Wicket sessions ([dbba567](https://github.com/knowledgepixels/nanodash/commit/dbba567c9feab04ac1cc9ca626482acc06119990))
* remove PubkeyItemTest for the deleted PubkeyItem component ([8af51b1](https://github.com/knowledgepixels/nanodash/commit/8af51b136d46e1eff4ead1cc7e7f15ca129f722e))
* verify Create + Retract introduction action form-fills ([a12be5e](https://github.com/knowledgepixels/nanodash/commit/a12be5eba1985b6e905e01857033f9c7a7e61d77))

### Build and continuous integration

* **deps:** update jacoco-maven-plugin to v0.8.15 ([66b704b](https://github.com/knowledgepixels/nanodash/commit/66b704b80a3768e85ba8991885c01316c71d92d2))
* **deps:** update maven-compiler-plugin to v3.15.0 ([a8aff6c](https://github.com/knowledgepixels/nanodash/commit/a8aff6c397104da15d2413b3ed1a50d540629234))
* **deps:** update maven-dependency-plugin to v3.11.0 ([758e3c1](https://github.com/knowledgepixels/nanodash/commit/758e3c117c1153c75fbb3cac264feab89f87d512))

### General maintenance

* delete unused PubkeyItem component ([4137d86](https://github.com/knowledgepixels/nanodash/commit/4137d86b4ea5a6e5343cb54290e55a2f8d057696))
* **dev:** raise Jetty form and response-header size limits ([bb9a8cb](https://github.com/knowledgepixels/nanodash/commit/bb9a8cba390ed62b95e1ebb2ee56bf88758d98f1))
* drop dead grlc query constants and rewire MaintainedResource panel ([48e8363](https://github.com/knowledgepixels/nanodash/commit/48e8363a9b7aeae62f931c451a9c2a5bca8d27c3))
* drop deprecated GET_PINNED_TEMPLATES/GET_PINNED_QUERIES paths ([f34ad76](https://github.com/knowledgepixels/nanodash/commit/f34ad76ff3287b6dcecb924727e13c7571ddc3b3))
* ignore /tmp folder ([7f64593](https://github.com/knowledgepixels/nanodash/commit/7f64593d8fb76d691bbf33b6a3048be6b6ecd533))
* log spaces-repo refresh stats for debugging ([506841c](https://github.com/knowledgepixels/nanodash/commit/506841cef19d65af14e46b9c2e7b84f83cc7f67d))
* Optimized Logging ([0f62815](https://github.com/knowledgepixels/nanodash/commit/0f62815542105a7dc6efb0473e70f2bfc9030ebc))
* point GET_SPACE_ROLES at the roleType-returning query republish ([1d0c376](https://github.com/knowledgepixels/nanodash/commit/1d0c376663c7d2e152cc56f01fe5a879d9aee463))
* remove Space pinned-resources feature ([d9c9476](https://github.com/knowledgepixels/nanodash/commit/d9c94763019755fbb90e8a55c4da3fca0998c627))
* run tests headless to suppress the browser-open side effect ([6bca996](https://github.com/knowledgepixels/nanodash/commit/6bca9965063b6b7b13c04d1697c4254495c81576))
* setting next snapshot version [skip ci] ([0aba8bd](https://github.com/knowledgepixels/nanodash/commit/0aba8bddfd9e6414a1c7a2a123c1e94e52702bd2))
* TODO-mark all programmatically-built SPARQL for grlc migration ([3f76d1d](https://github.com/knowledgepixels/nanodash/commit/3f76d1d2d4e76c8ac23f32bbc6925e729e0f45b1))

### Style improvements

* prefix "add view display" action label with ➕ ([fa91670](https://github.com/knowledgepixels/nanodash/commit/fa9167090da2b56544009a4cd7929cbeabc76ca6))
* remove margin-top of details summary ([9d65026](https://github.com/knowledgepixels/nanodash/commit/9d650263046e6a0b5338ec1b4b7234da69f3aa55))
* render "^" source-nanopub carets blue-ish instead of gray ([7028472](https://github.com/knowledgepixels/nanodash/commit/702847267ecdf28fa9946e3d16e98077c9d5a9af)), closes [#0B73DA](https://github.com/knowledgepixels/nanodash/issues/0B73DA)

### Refactoring

* bump nanopub to 1.90.0 and drop placeholder/expansion code it now provides ([334ccb4](https://github.com/knowledgepixels/nanodash/commit/334ccb413e222007e8d01919219bd4351fdb82d0))
* collapse per-repo cache + push view-display admin gate server-side ([e68ff10](https://github.com/knowledgepixels/nanodash/commit/e68ff10df71c94f51f8a5f53ae10d01860b8f934))
* drop dormant client-side user_pubkey/admin_pubkey view-query expansion ([8a88ffb](https://github.com/knowledgepixels/nanodash/commit/8a88ffb6ddb4c69b9b99ea7decb6c42fa0cb2437))
* extend nanopub-java QueryTemplate, drop duplicated GrlcQuery parsing ([6306697](https://github.com/knowledgepixels/nanodash/commit/6306697f16cd57a5b3fbd0ccbc187d97356142aa))
* route spaces-repo SPARQL through main query URL again ([4a3fa3e](https://github.com/knowledgepixels/nanodash/commit/4a3fa3e5578e9a81728d0e6c78d9eb0ba54928e0))
