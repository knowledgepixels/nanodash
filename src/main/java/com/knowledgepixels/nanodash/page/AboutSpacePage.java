...
public class AboutSpacePage extends NanodashPage {
    ...
    public AboutSpacePage(final PageParameters parameters) {
        ...
        add(QueryResultTableBuilder.create("presets", presetsQueryRef, new ViewDisplay(presetsView)).id(space.getId()).contextId(space.getId()).build());
        ...
        add(QueryResultTableBuilder.create("viewdisplays", vdQueryRef, new ViewDisplay(vdView)).id(space.getId()).contextId(space.getId()).build());
