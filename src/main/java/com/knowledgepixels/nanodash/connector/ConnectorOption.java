...
/**
 * Enum representing various connector options for the Nanodash application.
 */
public enum ConnectorOption {
    ...
    /**
     * Identification of a specimen with a taxon.
     */
    ...
    /**
     * Association between organisms and taxa.
     */
    ...
    /**
     * Association between taxon names.
     */
    ...
    /**
     * Specimen being discussed in a publication.
     */
    ...
    /**
     * Creates a new ConnectorOption with the specified parameters.
     *
     * @param name              the name of the connector option
     * @param explanation       a short explanation of the connector option, or null if not applicable
     * @param templateId        the ID of the template nanopublication for this connector option
     * @param exampleId         the ID of an example nanopublication for this connector option
     * @param prTemplateId      the ID of the PR template associated with this connector option
     * @param prTemplateOptions the options for the PR template, if any, as a space-separated string, or null if not applicable
     */
    ...
    /**
     * Returns the name of the connector option.
     *
     * @return the name of the connector option
     */
    ...
    /**
     * Returns a short explanation of the connector option.
     *
     * @return the explanation text, or null if not applicable
     */
    ...
    /**
     * Returns the ID of the template nanopublication for this connector option.
     *
     * @return the template nanopublication ID
     */
    ...
    /**
     * Returns the ID of an example nanopublication for this connector option.
     *
     * @return the example nanopublication ID
     */
    ...
    /**
     * Returns the ID of the PR template associated with this connector option.
     *
     * @return the PR template ID
     */
    ...
    /**
     * Returns the options for the PR template, if any.
     *
     * @return the PR template options as a space-separated string, or null if not applicable
     */
