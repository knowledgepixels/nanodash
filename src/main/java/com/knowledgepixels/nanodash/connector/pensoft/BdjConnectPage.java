...
public class BdjConnectPage extends ConnectPage {

	private static final long serialVersionUID = 1L;

	public static final String MOUNT_PATH = "/connector/pensoft/bdj/connect";

	public BdjConnectPage(Nanopub np, PageParameters params) {
		super(np, params);
	}
