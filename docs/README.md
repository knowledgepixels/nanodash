...
| [space-ref-identity](space-ref-identity.md) | 🚧 In progress | A space's identity is IRI + root-definition NPID (rival roots = distinct spaces); ref-aware views ship, per-ref `SpaceRepository` pending (coupled to nanopub-query roll-out) |
